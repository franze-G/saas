...
export default function Home() {
  return(
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      <h1 className='max-w-4xl text-5-1 font-bold md:text-6xl lg:text-7xl'>
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-2 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xls lg:p-4">
                  <Image 
                  ...
                  height={866}
                  quality={100}
                  className="rounded-md bg-white p-2 sm:p-8 shadow-2x1 ring-1 ring-gray-900/10"
                  />
                </div>
              </div>
            </div>
        ...
        <ol className="my-8 space-y-4 pt-4 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">Either starting out with a free plan or choose our {''}<Link href='/pricing' className="text-blue-700 underlined underline-offset-2">pro plan
              </Link>
              .
              </span>
            </div>
